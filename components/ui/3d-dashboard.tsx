  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="relative z-10 flex items-center justify-center w-full h-full">
        <div className="transform-gpu animate-fade-in-up">
          {/* 3D Dashboard Panel */}
          <div className="relative transform-gpu animate-float">
            {/* Panel 1 - Main Table */}
            <div 
              className="relative w-[300px] sm:w-[400px] lg:w-[500px] bg-black/40 backdrop-blur-md border border-[#1da84f]/20 rounded-xl shadow-xl transform-gpu transition-all duration-500 ease-out"
              style={{
                transform: isHovered 
