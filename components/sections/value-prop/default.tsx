    ...
    <Section className={cn("pt-10 sm:pt-12 md:pt-16 pb-12 sm:pb-16 md:pb-20", className)}>
      <div className="max-w-container mx-auto px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
          {/* Card 1 */}
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 sm:p-7 md:p-8 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_12px_40px_-10px_rgba(29,168,79,0.35)] hover:border-[#1da84f]/40">
        ...
        {/* Large bottom box */}
        <div className="mt-6 sm:mt-8 md:mt-10 rounded-2xl border border-white/10 bg-black/30 backdrop-blur-md p-6 sm:p-8 md:p-10 transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_16px_56px_-14px_rgba(29,168,79,0.3)] hover:border-[#1da84f]/40">
